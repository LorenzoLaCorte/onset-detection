...
for DURATION in durations_list:
    ...
    print("Traccia Peggiore sulla differenza in numero di onset tra Librosa e l'implementazione: " +
          str(lib_examples[list_diff_onset.index(max_diff_onset)]))
    print("Traccia Peggiore sulla differenza tra le medie degli onset di Librosa e Implementazione: " +
          str(lib_examples[list_mean_comparison.index(max_mean_comparison)]))
    print("Traccia Peggiore sulla vicinanza di onset tra Librosa e Implementazione: " +
          str(lib_examples[list_comparison_perc.index(max_comparison_perc)]))

    print("Traccia Migliore sulla differenza in numero di onset tra Librosa e l'implementazione: " +
          str(lib_examples[list_diff_onset.index(min_diff_onset)]))
    print("Traccia Migliore sulla differenza tra le medie degli onset di Librosa e Implementazione: " +
          str(lib_examples[list_mean_comparison.index(min_mean_comparison)]))
    print("Traccia Migliore sulla vicinanza di onset tra Librosa e Implementazione: " +
